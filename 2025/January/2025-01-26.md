...
*   mvn dependency:tree**Usage:**Displays a hierarchical tree of dependencies. This helps identify conflicts (e.g., multiple versions of the same library).
    
*   mvn dependency:analyze**Usage:**Checks for unused or undeclared dependencies.
